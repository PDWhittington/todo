...
public class CommitCommandExecutor(
    ...
    : CommandExecutorBase<CommitCommand>(outputWriter), ICommitCommandExecutor
{
    public override void Execute(CommitCommand commitCommand)
    {
        ...
        var commitMessage = commitCommand.CommitMessage ?? $"Synced as at {dateAccessor.GetNow():yyyy-MM-dd HH:mm:ss}";

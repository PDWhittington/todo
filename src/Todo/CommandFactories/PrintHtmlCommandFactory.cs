...
public class PrintHtmlCommandFactory(IDateParser dateParser, IConfigurationProvider configurationProvider, 
    IConsoleTextFormatter consoleTextFormatter, IOutputWriter outputWriter)
    : CommandFactoryBase<PrintHtmlCommand>(configurationProvider, consoleTextFormatter, outputWriter, Words)
{
